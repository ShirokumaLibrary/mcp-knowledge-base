...
# /ai-spec:quick - Quick Spec Command
...
```bash
/ai-spec:quick "add user profile picture upload"
/ai-spec:quick "implement CSV export for reports"
/ai-spec:quick "add dark mode toggle"
```
...
- `.claude/commands/ai-spec/micro.md` - For smaller changes
- `.claude/commands/ai-spec.md` - For complex features
