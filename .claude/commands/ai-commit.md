...
After completing the release workflow above, publish to npm:
...
# 2. Check package will publish correctly
npm pack --dry-run
...
# 5. Test installation
npm install -g @shirokuma-library/mcp-knowledge-base@latest
