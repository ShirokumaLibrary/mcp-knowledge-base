...
- related: array (unified list of all related items)
- related_tasks: array (for backward compatibility)
- related_documents: array (for backward compatibility)
```
...
- id: string (auto-generated)
- related: empty array
- related_tasks: empty array (for backward compatibility)
- related_documents: empty array (for backward compatibility)
