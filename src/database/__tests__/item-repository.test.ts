...
import type { IDatabase } from '../interfaces/repository-interfaces.js';
...
describe('ItemRepository', () => {
  ...
  let mockStatusRepo: jest.Mocked<StatusRepository>;
  let mockTagRepo: jest.Mocked<TagRepository>;
  let mockTypeRepo: jest.Mocked<TypeRepository>;
  ...
  beforeEach(() => {
    ...
    const MockedStatusRepository = StatusRepository as jest.MockedClass<typeof StatusRepository>;
    const MockedTagRepository = TagRepository as jest.MockedClass<typeof TagRepository>;
    const MockedTypeRepository = TypeRepository as jest.MockedClass<typeof TypeRepository>;
    ...
    } as unknown as jest.Mocked<StatusRepository>;
    ...
    } as unknown as jest.Mocked<TypeRepository>;
    ...
    itemRepo = new ItemRepository(mockDb as any, testDataDir, mockStatusRepo, mockTagRepo);
  });
