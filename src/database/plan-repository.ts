...
export class PlanRepository extends BaseRepository {
  ...
  private readonly sequenceType = 'plans';
   ...
   */
  private async parseMarkdownPlan(content: string): Promise<PlanInternal | null> {
   ...
   */
  private toExternalPlan(internal: PlanInternal): Plan {
    const { status_id, ...external } = internal;
    return external;
  }

  private async writeMarkdownPlan(plan: PlanInternal): Promise<void> {
   ...
   */
  async syncPlanToSQLite(plan: PlanInternal): Promise<void> {
  ...
  async createPlan(title: string, content?: string, priority: string = 'medium', status?: string, start_date?: string, end_date?: string, tags?: string[], description?: string): Promise<Plan> {
    await this.ensureDirectoryExists();
  ...
  async updatePlan(id: number, title?: string, content?: string, priority?: string, status?: string, start_date?: string, end_date?: string, tags?: string[], description?: string): Promise<boolean> {
