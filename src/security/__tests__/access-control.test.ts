...
describe('Access Control', () => {
  ...
  describe('Permission checking', () => {
    it('should grant permission to admin for any action', () => {
      ...
      expect(() => 
        acm.requirePermission(user, ResourceType.ISSUE, Permission.CREATE)
      ).not.toThrow();
    ...
    it('should grant basic permissions to users', () => {
      ...
      expect(() => 
        acm.requirePermission(user, ResourceType.ISSUE, Permission.READ)
      ).not.toThrow();
    ...
    it('should deny most permissions to anonymous users', () => {
      ...
      expect(() => 
        acm.requirePermission(user, ResourceType.ISSUE, Permission.UPDATE)
      ).toThrow(BusinessRuleError);
    });
  ...
  describe('Permission combinations', () => {
    it('should handle multiple resource types', () => {
      ...
      expect(() => 
        acm.requirePermission(user, ResourceType.PLAN, Permission.CREATE)
      ).not.toThrow();
      
      expect(() => 
        acm.requirePermission(user, ResourceType.DOCUMENT, Permission.READ)
      ).not.toThrow();
    });
    ...
    it('should validate permission values', () => {
      ...
      expect(() => 
        acm.requirePermission(user, ResourceType.ISSUE, 'INVALID' as Permission)
      ).toThrow(BusinessRuleError);
    });
  });
