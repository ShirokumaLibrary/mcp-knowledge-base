...
async function migrateFiles(directory: string, oldPrefix: string, newPrefix: string): Promise<number> {
  let migratedCount = 0;
...
async function migrateDocDirectory(documentsPath: string): Promise<number> {
