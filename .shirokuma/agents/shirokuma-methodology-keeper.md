...
tools: Read, mcp__{{MCP_NAME}}__get_items, mcp__{{MCP_NAME}}__get_item_detail, mcp__{{MCP_NAME}}__create_item, mcp__{{MCP_NAME}}__update_item, mcp__{{MCP_NAME}}__search_items, mcp__{{MCP_NAME}}__search_items_by_tag, mcp__{{MCP_NAME}}__get_tags, mcp__{{MCP_NAME}}__get_types
---
