...
tools: mcp__{{MCP_NAME}}__get_items, mcp__{{MCP_NAME}}__get_item_detail, mcp__{{MCP_NAME}}__create_item, mcp__{{MCP_NAME}}__update_item, mcp__{{MCP_NAME}}__delete_item, mcp__{{MCP_NAME}}__search_items, mcp__{{MCP_NAME}}__search_items_by_tag, mcp__{{MCP_NAME}}__get_statuses, mcp__{{MCP_NAME}}__get_tags, mcp__{{MCP_NAME}}__create_tag, mcp__{{MCP_NAME}}__delete_tag, mcp__{{MCP_NAME}}__search_tags, mcp__{{MCP_NAME}}__get_types, mcp__{{MCP_NAME}}__create_type, mcp__{{MCP_NAME}}__update_type, mcp__{{MCP_NAME}}__delete_type, mcp__{{MCP_NAME}}__search_suggest, mcp__{{MCP_NAME}}__get_current_state, mcp__{{MCP_NAME}}__update_current_state, mcp__{{MCP_NAME}}__change_item_type, mcp__{{MCP_NAME}}__index_codebase, mcp__{{MCP_NAME}}__search_code, mcp__{{MCP_NAME}}__get_related_files, mcp__{{MCP_NAME}}__get_index_status
---
