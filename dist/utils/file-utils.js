...
export async function ensureDirectoryExists(dirPath) {
    try {
        ...
        throw new FileSystemError(`Failed to create directory: ${dirPath}`, 'create', dirPath, { error });
    }
}
/**
...
export async function readFileSafe(filePath) {
    try {
        ...
        throw new FileSystemError(`Failed to read file: ${filePath}`, 'read', filePath, { error });
    }
}
/**
...
export async function writeFileSafe(filePath, content) {
    try {
        ...
        throw new FileSystemError(`Failed to write file: ${filePath}`, 'write', filePath, { error });
    }
}
/**
...
export async function deleteFileSafe(filePath) {
    try {
        ...
        throw new FileSystemError(`Failed to delete file: ${filePath}`, 'delete', filePath, { error });
    }
}
