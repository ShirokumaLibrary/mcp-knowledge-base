...
export declare class KnowledgeRepository extends BaseRepository {
     ...
     */
    createKnowledge(title: string, content: string, tags?: string[], description?: string): Promise<Knowledge>;
    updateKnowledge(id: number, title?: string, content?: string, tags?: string[], description?: string): Promise<boolean>;
