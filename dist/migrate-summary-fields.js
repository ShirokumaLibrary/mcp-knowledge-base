...
async function migrate() {
    ...
    try {
        ...
        const issueHasSummary = issueColumns.some((col) => col.name === 'summary');
        if (!issueHasSummary) {
        ...
        const planHasSummary = planColumns.some((col) => col.name === 'summary');
        if (!planHasSummary) {
        ...
        const knowledgeHasSummary = knowledgeColumns.some((col) => col.name === 'summary');
        ...
        const docsHasSummary = docsColumns.some((col) => col.name === 'summary');
        if (!docsHasSummary) {
...
//# sourceMappingURL=migrate-summary-fields.js.map