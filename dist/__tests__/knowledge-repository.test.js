...
describe('KnowledgeRepository Async Tests', () => {
    ...
    describe('Async file operations', () => {
        ...
        test('should create knowledge with async file write', async () => {
            const knowledge = await db.createKnowledge('Test Knowledge', '# Important Information\n\nThis is test knowledge content.', // @ai-example: Markdown content required
            ['test', 'async']);
        ...
        test('should handle concurrent knowledge operations', async () => {
            ...
            const promises = Array.from({ length: 5 }, (_, i) => db.createKnowledge(`Concurrent Knowledge ${i}`, `Content for knowledge ${i}`, [`tag${i}`] // @ai-integration-point: Tags auto-registered in tags table
            ));
        ...
        test('should update knowledge with async file operations', async () => {
            ...
            const updateResult = await db.updateKnowledge(knowledge.id, 'Updated Title', 'Updated content with more details', ['updated', 'test'] // @ai-integration-point: New tags auto-registered
            );
...
//# sourceMappingURL=knowledge-repository.test.js.map