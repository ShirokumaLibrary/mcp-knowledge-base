...
describe('IssueTrackerServer', () => {
    ...
    beforeEach(async () => {
        ...
        FileIssueDatabase.mockImplementation(() => mockDb);
    ...
    describe('tool call handling', () => {
        ...
        it('should preserve McpErrors', async () => {
            ...
            mockTagHandlers.handleCreateTag.mockRejectedValue(new McpError(ErrorCode.InvalidRequest, 'Test error'));
            const request = {
                params: {
                    name: 'create_tag',
                    arguments: { name: 'test-tag' }
        ...
        it('should wrap non-McpErrors', async () => {
            ...
            await expect(callToolHandler(request)).rejects.toThrow(McpError);
            const error = await callToolHandler(request).catch((e) => e);
    ...
    describe('unified handlers', () => {
        ...
        beforeEach(async () => {
            ...
            handleUnifiedToolCall.mockImplementation((toolName, args, handlers) => {
