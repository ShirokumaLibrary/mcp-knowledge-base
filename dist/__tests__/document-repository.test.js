...
describe('DocumentRepository', () => {
    ...
    describe('createDocument', () => {
        it('should create a doc with proper ID sequence', async () => {
            const doc = await repo.createDocument('docs', 'Test Document', 'This is test content', ['test', 'doc'], 'Test description');
        ...
        it('should create a knowledge with proper ID sequence', async () => {
            const knowledge = await repo.createDocument('knowledge', 'Test Knowledge', 'This is knowledge content', ['test', 'knowledge']);
    ...
    describe('getDocument', () => {
        it('should retrieve document by type and ID', async () => {
            const created = await repo.createDocument('docs', 'Test Document', 'Test content', ['test']);
    ...
    describe('updateDocument', () => {
        it('should update document fields', async () => {
            const created = await repo.createDocument('knowledge', 'Original Title', 'Original content', ['original']);
            const success = await repo.updateDocument('knowledge', created.id, 'Updated Title', 'Updated content', ['updated', 'tag'], 'Updated description');
...
//# sourceMappingURL=document-repository.test.js.map