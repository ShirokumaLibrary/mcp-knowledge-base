...
describe('DocumentRepository', () => {
    ...
    describe('createDocument', () => {
        it('should create a doc with proper ID sequence', async () => {
            const doc = await repo.createDocument('doc', 'Test Document', 'This is test content', ['test', 'doc'], 'Test description');
    ...
    describe('getDocument', () => {
        it('should retrieve document by type and ID', async () => {
            const created = await repo.createDocument('doc', 'Test Document', 'Test content', ['test']);
