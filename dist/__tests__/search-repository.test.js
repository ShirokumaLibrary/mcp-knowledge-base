...
describe('SearchRepository', () => {
    ...
    describe('Performance and edge cases', () => {
      ...
      `);
        ...
        it('should handle concurrent searches', async () => {
            const searches = Array(10).fill(null).map((_, i) => searchRepo.searchAllByTag(i % 2 === 0 ? 'api' : 'feature'));
    ...
    describe('Cross-type search functionality', () => {
      ...
      `);
            ...
            expect(results1.issues.find((i) => i.id === 100)).toBeTruthy();
            expect(results2.issues.find((i) => i.id === 100)).toBeTruthy();
            expect(results3.issues.find((i) => i.id === 100)).toBeTruthy();
        });
    });
});
