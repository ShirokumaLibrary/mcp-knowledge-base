...
describe('Daily Summary Validation', () => {
    ...
    describe('Duplicate Summary Prevention', () => {
        ...
        it('should prevent creating duplicate summaries for the same date', () => {
            ...
            const summary1 = sessionManager.createDailySummary(testDate, 'First Summary', 'This is the first summary', ['test']);
            expect(summary1).toBeDefined();
            expect(summary1.date).toBe(testDate);
            // Try to create duplicate - should throw
            expect(() => {
                sessionManager.createDailySummary(testDate, 'Second Summary', 'This should fail', ['test']);
        ...
        it('should allow creating summaries for different dates', () => {
            const summary1 = sessionManager.createDailySummary('2025-07-30', 'July Summary', 'Summary for July', []);
            const summary2 = sessionManager.createDailySummary('2025-07-31', 'August Summary', 'Summary for August', []);
