...
import { createSimpleMockDatabase, resetAllMocks } from '../../test-utils/mock-helpers.js';
describe('ItemHandlers', () => {
    ...
    describe('handleGetItems', () => {
        ...
        it('should filter by status IDs when provided', async () => {
            ...
            // Assert
            expect(mockDb.getAllTasksSummary).toHaveBeenCalledWith('issues', false, // includeClosedStatuses defaults to false
            [1, 2, 3]);
        });
    });
    ...
    describe('handleCreateItem', () => {
        it('should create task with all fields', async () => {
            ...
            // Assert
            expect(mockDb.createTask).toHaveBeenCalledWith('issues', 'New Issue', 'Issue content', 'high', 'open', ['bug', 'urgent'], undefined, '2024-01-01', '2024-01-31', undefined, undefined);
        ...
        it('should create document with all fields', async () => {
            ...
            // Assert
            expect(mockDb.createDocument).toHaveBeenCalledWith('docs', 'New Doc', 'Doc content', ['documentation'], undefined, ['issues-1'], ['knowledge-1']);
    ...
    describe('handleUpdateItem', () => {
        it('should update task successfully', async () => {
            ...
            // Assert
            expect(mockDb.updateTask).toHaveBeenCalledWith('issues', 1, 'Updated Issue', undefined, 'medium', undefined, undefined, undefined, undefined, undefined, undefined, undefined);
        ...
        it('should update document successfully', async () => {
            ...
            // Assert
            expect(mockDb.updateDocument).toHaveBeenCalledWith('docs', 1, 'Updated Doc', 'New content', undefined, undefined, undefined, undefined);
