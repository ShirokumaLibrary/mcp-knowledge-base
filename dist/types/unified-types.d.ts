 ...
 */
export declare function isTaskItem(item: UnifiedItem): item is TaskItem;
export declare function isDocumentItem(item: UnifiedItem): item is DocumentItem;
export declare function isSessionItem(item: UnifiedItem): item is SessionItem;
export declare function isSummaryItem(item: UnifiedItem): item is SummaryItem;
/**
 * @ai-intent Helper for parsing related item references
 * @ai-pattern Consistent format: "type-id"
 */
export declare class RelatedItemsHelper {
    static parse(ref: string): {
        type: string;
        id: string;
    };
    static format(type: string, id: string | number): string;
    static filterByBaseType(related: string[], baseTypeCheck: (type: string) => boolean): string[];
}
/**
