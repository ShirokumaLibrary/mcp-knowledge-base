...
export declare class SessionManager {
     ...
     */
    createSession(title: string, content?: string, tags?: string[], id?: string, // @ai-logic: Custom ID for imports
    datetime?: string, // @ai-logic: Custom datetime for past data migration (ISO 8601 format)
    related_tasks?: string[], related_documents?: string[], description?: string): Promise<Session>;
    /**
     ...
     */
    updateSession(id: string, title?: string, content?: string, tags?: string[], related_tasks?: string[], related_documents?: string[], description?: string): Promise<Session>;
    /**
     ...
     */
    createDaily(date: string, title: string, content: string, tags?: string[], related_tasks?: string[], related_documents?: string[], description?: string): Promise<Daily>;
    /**
     ...
     */
    updateDaily(date: string, title?: string, content?: string, tags?: string[], related_tasks?: string[], related_documents?: string[], description?: string): Promise<Daily>;
    /**
     ...
     */
    getDailyDetail(date: string): Promise<Daily | null>;
}
